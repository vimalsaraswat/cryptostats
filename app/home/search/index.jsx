  ...
  if (loading) return <main>Loading....</main>;
    ...
    return (
      <div className="flex flex-col">
        <div className="flex md:order-2">
          <div className="relative  md:block">
            ...
            <button
              ...
              type="submit"
              class="text-white absolute right-0.5 inset-y-0 h-8 my-auto bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Search
            </button>
          </div>
        ...
        {showResults && (
          <div ref={resultsRef} id="search-resuts" className="relative w-0 h-0">
