...
export default function header() {
  return (
    <header className="bg-white max-w-screen dark:bg-gray-900 w-full border-b border-gray-200 dark:border-gray-600">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-around sm:justify-evenly md:justify-between mx-auto p-4">
        <Logo />
        <Nav />
      </div>
    </header>
...
function Nav() {
  ...
  return (
    <>
      ...
      <div className={`${!menuOpen && "hidden"} sm:block w-full sm:w-auto`}>
        <NavItems />
      </div>
    </>
  );
